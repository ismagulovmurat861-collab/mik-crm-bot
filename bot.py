...
AGENT_SYSTEM = (
    ...
    f"3. НЕ обещай планировки и шахматки. Пиши: 'Запрос принят. Я передаю параметры руководителю — он сверится с нашей внутренней базой свободных квартир и свяжется с вами. Напишите ваш телефон или свяжитесь сами: {+77058060781}.'"
)
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if len(numbers) >= 1:
        ...
        if loan > 0:
            reply = (
                ...
                f"Данные переданы руководителю, он сверится с базой свободных квартир новостроек и свяжется с вами. Напишите ваш телефон или свяжитесь напрямую: {+77058060781}"
            )
    ...
    try:
        ...
        reply_text = f"Запрос принят! Оставьте ваш телефон для связи или напишите мне напрямую на WhatsApp: {+77058060781}"
...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "Вы планируете КУПИТЬ квартиру (в ипотеку / наличные)СДАТЬ или СНЯТЬ?"
    )
